...
const lessonTitles = {
  ...
  21: "Will You or Won't You? — Future with 'Will' for Predictions, Promises & Spontaneous Decisions",
  22: 'At the Airport — Check-In, Security, Gates & Surviving the First International Flight',
  23: 'On the Plane & Arriving in Paris — Flight Attendants, Customs & First Moments in France',
  24: "Milestone Check-In — Halfway Point: What She Knows, What She Can Do & Where She's Going",
  25: "Let's Talk About Series! — Describing TV Shows, Giving Opinions & Using Pop Culture as Grammar Tools",
  26: 'Getting Around Paris — Metro, Maps, Bus & Asking for Directions Like a Local',
  27: 'Talking About Feelings & Emotions — School, Travel & Life in a New Place',
  28: 'At the Hotel — Checking In, Asking for Help & Handling Room Problems',
  29: 'Eating Out in Paris — Full Restaurant Experience: Menus, Orders, Allergies & Bill',
  30: 'Visiting Museums & Monuments — Louvre, Versailles & Talking About Art and History',
  31: 'Making Friends Abroad — Starting Conversations, Small Talk & Friendship in English',
  32: 'Shopping in Paris — Boutiques, Souvenirs, Bargaining & Money in English',
  33: 'Telling Stories with Confidence — Narrative Tenses & Sounding Like a Storyteller',
  34: 'Talking About Health & Lifestyle — Eating Well, Exercising & Healthy Habits',
  35: 'Talking About the Future — Dreams, Ambitions & Conditional Language',
  36: 'Handling Problems & Complaining Politely — When Things Go Wrong in Paris',
  37: 'Social Media, Pop Culture & Celebrity Talk — Fame, Trends & Digital Life',
  38: 'Talking About School & Study Life — Academic English for Subjects & Learning',
  39: 'Real Conversations, Real Confidence — Fluency Drills & Sounding Natural',
  40: "Block 2 Closing & Preview — Halfway-Home Celebration & Vision for the Final Stretch",
  41: 'Block 3 Aula 41 — Conteúdo será adicionado no próximo bloco',
  42: 'Block 3 Aula 42 — Conteúdo será adicionado no próximo bloco',
  43: 'Block 3 Aula 43 — Conteúdo será adicionado no próximo bloco',
  44: 'Block 3 Aula 44 — Conteúdo será adicionado no próximo bloco',
  45: 'Block 3 Aula 45 — Conteúdo será adicionado no próximo bloco',
  46: 'Block 3 Aula 46 — Conteúdo será adicionado no próximo bloco',
  47: 'Block 3 Aula 47 — Conteúdo será adicionado no próximo bloco',
  48: 'Final Class — Celebration & Continue your English Journey',
};
