#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 11 nos hubs (prof + aluno) de Eduarda de forma ADITIVA.
Aulas passadas intactas. Idempotente: se ex-lesson-11 ja existe, aborta.
Molde: diogo-leal-aula8/insert_hub.py. Ancora de complementares = l10-video
(Eduarda usa 'video' como 3a midia, nao 'youtube')."""
import os, re
...
ORDER_AMAP = '  "[order-l11]": "/audio/eduarda-gabriel/order_l11_sequence.mp3",'
...
def patch(path, is_prof):
    ...
    # 3. complementares l11 apos o ultimo wrapper l10 (3a midia = video)
    yi = s.index('data-media="l10-video"')
    ...
    if is_prof:
        ci = s.index('eduarda-gabriel-aula10.html?autostart=1')
