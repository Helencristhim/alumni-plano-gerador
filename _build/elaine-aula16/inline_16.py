#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Inline Aula 16 (Review 2) into the Elaine monolith (prof+aluno). counterMap already
extended to vocabGrid30 by inline_15, so vocab counters (17/18) work. ADITIVO only."""
import os, re, json
...
A = os.path.join(ROOT, 'public', 'professor', 'elaine-mieko-pinho-aula16.html')
N = 16; OFF = 28 * (N - 1)            # 420
VG = (17, 18)
TITLE = 'Review 2 -- Food and Getting Around'; SUB = 'Full day simulation (Lessons 9-15)'
STAMP = '<div class="stamp" id="stamp16" data-label="Review 2" style="background-image:url(\'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=200&q=80\')"></div>'
PREV_STAMP = '<div class="stamp" id="stamp15" data-label="Shopping" style="background-image:url(\'https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=200&q=80\')"></div>'
PREV_TOTLESS = 'var totalLessons = 15;'; NEW_TOTLESS = 'var totalLessons = 16;'
PREV_TOTSLIDES = 'var totalSlides = 420;'; NEW_TOTSLIDES = 'var totalSlides = 448;'
PREV_CARD_CLOSE = '</div><!-- /lesson-card L15 -->'
