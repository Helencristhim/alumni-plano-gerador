#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 11 nos hubs (prof + aluno) de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l11]": "/audio/estephano-akihito-ishii/a11_order_journey.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula10.html?autostart=1')
