#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Inline Aula 14 into the Elaine monolith (prof+aluno), like aulas 8-13."""
import os, re, json
...
A = os.path.join(ROOT, 'public', 'professor', 'elaine-mieko-pinho-aula14.html')
N = 14; OFF = 28 * (N - 1)            # 364
VG = (13, 14)
TITLE = 'Public Transportation'; SUB = 'Subway, bus &amp; tickets'
STAMP = '<div class="stamp" id="stamp14" data-label="Transport" style="background-image:url(\'https://images.unsplash.com/photo-1556122071-e404eaedb77f?w=200&q=80\')"></div>'
PREV_STAMP = '<div class="stamp" id="stamp13" data-label="Directions" style="background-image:url(\'https://images.unsplash.com/photo-1502920514313-52581002a659?w=200&q=80\')"></div>'
PREV_TOTLESS = 'var totalLessons = 13;'; NEW_TOTLESS = 'var totalLessons = 14;'
PREV_TOTSLIDES = 'var totalSlides = 364;'; NEW_TOTSLIDES = 'var totalSlides = 392;'
PREV_CARD_CLOSE = '</div><!-- /lesson-card L13 -->'
