#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 16 nos hubs (prof + aluno) de milton-sayegh
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-16 ja existe, SKIP.
Molde: milton-sayegh-aula15/insert_hub.py (sem extra-audio)."""
import os, re
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('milton-sayegh-aula15.html?autostart=1')
