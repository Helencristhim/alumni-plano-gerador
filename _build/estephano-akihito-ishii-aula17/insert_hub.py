#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 17 nos hubs (prof + aluno) de forma ADITIVA.
Aulas passadas intactas. Idempotente: se ex-lesson-17 ja existe, aborta."""
import os, re
...
ORDER_AMAP = '  "[order-l17]": "/audio/estephano-akihito-ishii/a17_order_my_desk.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula16.html?autostart=1')
