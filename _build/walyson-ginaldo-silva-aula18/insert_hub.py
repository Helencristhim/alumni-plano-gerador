#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 18 do Walyson nos hubs
monoliticos (inline) prof/aluno. Nao toca aulas 1-17. Adiciona: card IN CLASS
...
amap_lines.append(f'  "[order-l18]": "{AUDIO_BASE}pc18_small_talk_steps.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), formato identico aos cards existentes do Walyson (accent) ---
CARD18 = (
    '    <a href="/professor/walyson-ginaldo-silva-aula18.html?autostart=1"  '
    ...
    '      <div><div style="font-weight:600;font-size:.95rem">Small Talk Before Business</div>'
    '<div style="font-size:.8rem;color:var(--text-dim)">Building rapport before the meeting starts '
    '-- open questions and follow-ups -- 28 slides</div></div>\n'
    '    </a>')

STAMP17 = ('<div class="stamp" id="stamp17" data-label="Deal Sealer" style="background-image:url(\''
           'https://images.unsplash.com/photo-1556745757-8d76bdb6984b?w=200&q=80\')"></div>')
STAMP18 = ('\n<div class="stamp" id="stamp18" data-label="Rapport Builder" style="background-image:url(\''
           'https://images.unsplash.com/photo-1543269865-cbf427effbad?w=200&q=80\')"></div>')

# tail do card IN CLASS da aula 17 (Closing the Deal) — ancora aditiva (so prof)
CARD17_TAIL = (
    '      <div><div style="font-weight:600;font-size:.95rem">Closing the Deal</div>'
    '<div style="font-size:.8rem;color:var(--text-dim)">Confirming the final agreement and next steps in writing '
    '-- reported speech -- 28 slides</div></div>\n'
    '    </a>')
