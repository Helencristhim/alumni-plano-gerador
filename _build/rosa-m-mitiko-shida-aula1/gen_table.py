...
Uso (da raiz do worktree):
    python3 _build/rosa-m-mitiko-shida-aula1/gen_table.py <aula_atual> > /tmp/table.html
...
PERFIL = os.path.expanduser('~/alumni-tools/perfis/rosa-m-mitiko-shida.json')
...
print(f'  <p style="font-size:.78rem;color:var(--text-dim);margin-top:.6rem;font-style:italic">'
      ...
      f'atendendo ao pedido dela por leitura dirigida sem transformar o curso inteiro em leitura. '
      f'Cada aula acrescenta 10 a 12 expressões novas, e nenhuma expressão volta como conte&#250;do novo '
