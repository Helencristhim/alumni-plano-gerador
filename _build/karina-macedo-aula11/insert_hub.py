#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 11 da Karina nos hubs (prof + aluno) de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l11]": "/audio/karina-macedo/a11_order_call.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('karina-macedo-aula10.html?autostart=1')
