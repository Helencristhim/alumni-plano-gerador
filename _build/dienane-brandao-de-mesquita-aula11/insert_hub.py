#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 11 nos hubs (prof + aluno) de dienane-brandao-de-mesquita
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-11 ja existe, aborta.
...
ORDER_AMAP = '  "[order-l11]": "/audio/dienane-brandao-de-mesquita/pc11_order_a_rainy_day.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('dienane-brandao-de-mesquita-aula10.html?autostart=1')
