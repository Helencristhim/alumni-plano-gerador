#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 14 nos hubs (prof + aluno) de milton-sayegh
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-14 ja existe, SKIP.
Molde: milton-sayegh-aula13/insert_hub.py (sem extra-audio)."""
import os, re
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('milton-sayegh-aula13.html?autostart=1')
