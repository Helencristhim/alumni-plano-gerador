...
ROOT = '/home/dan/dev/work/better/wt-marcos'
N = 19
STAMP_LABEL = 'Email Pro'
STAMP_IMG = 'https://images.unsplash.com/photo-1596526131083-e8c633c948d2?w=200&q=80'
...
def process(path, href_prefix):
    ...
    # 5b. window.TOTAL_AULAS prev -> N (header progress bar = aulas done / TOTAL_AULAS)
    s = s.replace(f'window.TOTAL_AULAS={prev}', f'window.TOTAL_AULAS={N}', 1)
