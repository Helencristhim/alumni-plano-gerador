#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 13 nos hubs (prof + aluno) de graziele-dias de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l13]": "/audio/graziele-dias/pc13_order_l13.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('graziele-dias-aula12.html?autostart=1')
