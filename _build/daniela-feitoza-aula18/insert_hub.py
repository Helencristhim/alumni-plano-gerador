#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 18 nos hubs da
Daniela Feitoza (prof + aluno). Replica a aula 17. NAO toca aulas 1-17.
stamp18, ex-lesson-18, complementares l18, audioMap; "Aulas 18-43" ->
"Aulas 19-43" e var totalLessons=17 -> 18.
"""
import os
import re
...
STAMP17 = ("<div class=\"stamp\" id=\"stamp17\" data-label=\"Then & Now\" "
