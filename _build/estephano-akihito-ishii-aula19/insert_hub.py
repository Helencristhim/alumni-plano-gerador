...
ORDER_AMAP = '  "[order-l19]": "/audio/estephano-akihito-ishii/a19_order_my_morning_online.mp3",'
...
def patch(path, is_prof):
    ...
    # 2. accordion ex-lesson-19 apos o FIM do card ex-lesson-18 (casando div/div)
    st = s.index('<div class="lesson-card" id="ex-lesson-18">')
    en = div_end(s, st)
    s = s[:en] + '\n' + accordion + s[en:]

    # 3. complementares l18 apos o ultimo wrapper l18
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula18.html?autostart=1')
