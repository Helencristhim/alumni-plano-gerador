{
  ...
  language:'The first four: <em>My name is&hellip;</em> &middot; <em>I am in&hellip;</em> &middot; <em>It is from&hellip; to&hellip;</em> &middot; <em>Breakfast is included.</em>',
  transcript:'No recording in this lesson. Listening enters in lesson 2, with three short questions at a hotel desk.',
  difficulties:'<strong>She will translate before speaking.</strong> Everyone does at this point. Do not correct it as an error &mdash; shorten the sentence instead. Four words leave no room to translate.<br><br>'+
    '<strong>She will answer with one word.</strong> Give the frame (<em>My name is&hellip;</em>) and ask again. Whole sentences are the first criterion of the cycle, and today is where that starts.<br><br>'+
    '<strong>The first mistake of this lesson matters more than the lesson.</strong> She stopped a course because she felt behind. When the first error comes, take it as normal out loud, in one sentence, and carry on. Do not make a speech about it.<br><br>'+
  ...
  evidence:'<ul>'+
    '<li><strong>The first sample of her production in any source.</strong> Everything in this cycle compares against it.</li>'+
    '<li>Whether the sentence comes out whole or in single words (criterion 1).</li>'+
