{
  goals:'<strong>To present the company in three minutes to a buyer who has never heard of it, and to hold two questions he did not see coming.</strong><ul>'+
        ...
        '<li>To ask for a question to be repeated in the middle of his own pitch.</li>'+
        '<li>To give an honest no and keep the conversation.</li></ul>',
  product:'The full recorded simulation &mdash; three-minute pitch and two-question Q&amp;A &mdash; which opens the evidence file of the cycle.',
  criteria:'<ul>'+
    '<li>Closes the pitch inside three minutes.</li>'+
  ...
  transcript:'The two questions are audio, played once each, and the transcript stays closed for the whole lesson. This is the only lesson in the block where he hears something he has not read first &mdash; which is the condition of the real meeting.',
  difficulties:'<strong>He will over-run three minutes.</strong> Everyone does on the first attempt, and the initial attempt in stage 2 exists to make that visible before any model is given.<br><br>'+
    '<strong>He will want to answer the first question with a plan rather than a fact.</strong> The honest answer is a number, and it may be a small one. Small is fine: the call in lesson 2 already established that a no changes price and timeline, not the deal.<br><br>'+
    '<strong>He may take over the meeting.</strong> It is the pattern that ended eight to ten teaching relationships, and here it has a shape: he starts running the conversation rather than being in it. Diane has an agenda and keeps it.<br><br>'+
    '<strong>He may go quiet after the fast question.</strong> That is the finding, not a failure of the lesson. Record it.',
  scaffolding:'Nothing on screen during either round. The four moves are on screen in stage 5 and go away before round 1.<br><br>'+
    '<strong>Support today is the role, not the language:</strong> Diane is consistent, has a reason for each question and does not rescue. That is what makes the improvisation safe enough to be worth measuring.',
