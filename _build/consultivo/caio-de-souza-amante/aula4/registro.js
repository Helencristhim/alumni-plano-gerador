{n:4,bloco:1,mod:'ESP',cod:'E1',fwNome:'ESP — Real World',
    ...
    stages:[
      ...
      {n:'Initial attempt',min:6},
      {n:'Targeted model / input',min:5},
      {n:'Guided discovery',min:5},
      {n:'Micropractice',min:5},
      {n:'Full simulation — round 1',min:8},
      {n:'Feedback + upgrade',min:4},
      {n:'Full simulation — round 2',min:4}
    ]}
