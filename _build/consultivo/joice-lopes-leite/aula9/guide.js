{
  ...
  goals:'<strong>To read the invitation to an international education meeting and say out loud, in one minute, what the event is, when it is, and what she will do there &mdash; with the text off the screen.</strong><ul>'+
        ...
        '<li>To say what they want from her, and not only what the event is.</li>'+
        '<li>To speak in sentences rather than in single words.</li></ul>',
  product:'A one-minute recording about the meeting, followed by the same thing in thirty seconds for a colleague who asked in the corridor.',
  criteria:'<ul>'+
    '<li>Says the date and the place without going back to the text.</li>'+
  ...
  transcript:'No recording in this lesson. The invitation is read, not heard. Listening enters in lesson 10 &mdash; and listening is the skill the teacher has flagged twice.',
  difficulties:'<strong>She will ask for a translation.</strong> The teacher recorded it on 31/08: she said she needs translation in order to answer. Do not translate. Give the English sentence she needs and let her repeat it &mdash; the support is the <em>form</em>, never the meaning in Portuguese.<br><br>'+
    '<strong>She will answer in single words.</strong> That is precisely what lesson 9 exists to change, and it is the third criterion of the cycle. When it happens, give her the frame (<em>It is a meeting about&hellip;</em>) and ask again.<br><br>'+
