{
  ...
  goals:'<strong>To come into an international online meeting: say who she is in one minute, ask two questions, and answer one she did not expect.</strong><ul>'+
        ...
        '<li>To ask for a repeat in the middle of a live conversation.</li>'+
        '<li>To keep talking after she has answered.</li></ul>',
  product:'The full recorded simulation &mdash; introduction, two questions and the unprepared answer &mdash; which opens the evidence file of the cycle.',
  criteria:'<ul>'+
    '<li>Says who she is and what she does with nothing on screen.</li>'+
  ...
  transcript:'The question is audio, played once, and the transcript stays closed. It is the only moment of the block where she hears something she has not read first &mdash; which is the condition of the real meeting.',
  difficulties:'<strong>She will wait to be invited.</strong> It is the pattern in her own words: in a group, she closes. Nobody calls her name in stage 7. If she waits the whole two minutes, that is the finding &mdash; record it, and it is what the next block is built against.<br><br>'+
    '<strong>She will ask for a translation</strong> when the unexpected question lands. Give the English again, more slowly, and let her ask for the repeat &mdash; that is the move from lesson 10 and it counts as a success, not a failure.<br><br>'+
    '<strong>She may answer in single words.</strong> Full sentences are the third criterion of the cycle. Give the frame and ask again.<br><br>'+
    '<strong>Shame in front of a group is the real obstacle.</strong> The room is simulated by you and there is no level comparison anywhere in it. Say that once, at the start, and then never again.',
  scaffolding:'Nothing on screen during either round. The four moves are visible in stage 6 and go away before round 1.<br><br>'+
    '<strong>Support today is the role, not the language:</strong> the four people are consistent, each has a reason to be there, and none of them rescues her. That is what makes the improvisation safe enough to be worth measuring.',
