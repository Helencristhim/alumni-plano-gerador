{
  ...
  criteria:'<ul>'+
    ...
    '<li>She does not stop the conversation to translate.</li>'+
    '<li>She asks without waiting to be invited.</li></ul>',
  prep:'<strong>In eight lessons she learned to answer and never to ask.</strong> There is no record of a single question of hers in English in any of the seven documented lessons. That is the axis of this block, and this is the lesson where it becomes a form.<br><br>'+
       'Stage 3 gives her <strong>six answers with the questions removed</strong>. She rebuilds the questions &mdash; which is how the form appears without you handing over the rule.<br><br>'+
       'The rule is one line and it comes <em>after</em> the attempt: <em>do/does</em> for actions, <em>are/is</em> for states, and the question word in front when it is not a yes-or-no.',
  language:'The question form: <em>Where do you work?</em> &middot; <em>What do you teach?</em> &middot; <em>Are you from Brazil?</em> &middot; <em>Do you use AI with your students?</em> &middot; <em>How many students do you have?</em>',
  transcript:'No recording in this lesson. Listening was lesson 10; this one is production.',
  difficulties:'<strong>She will make statements with a question mark</strong> &mdash; <em>You work in a school?</em> It is understood and it is not a question form. Correct the word order once, gently, and move on: intonation is the easy half.<br><br>'+
    '<strong>The second question is harder than the first.</strong> A list of prepared questions is not a conversation; the one that comes from the answer is. That is what stage 8 measures.<br><br>'+
    '<strong>If the six come out easily with you, that is the finding</strong> &mdash; the obstacle is not the form, it is speaking in a group, which she named herself. Record it: it changes the design of lesson 12.<br><br>'+
    '<strong>Fatigue is real</strong> (declared ADHD). The stages are short on purpose; do not merge two of them to save time.',
  scaffolding:'The six answers stay on screen through stages 3 to 6 and <strong>close before stage 8</strong>. The rule appears once, in one line, after her attempt.<br><br>'+
    'Support here is the sentence opening, never the whole question. Offering <em>Where do you&hellip;?</em> and waiting is support; finishing her question is doing the lesson for her.<br><br>'+
    '<strong>Portuguese is a complement, never the task.</strong>',
