{
  ...
  goals:'<strong>To answer an opinion prompt in forty-five timed seconds, with a position, two reasons, one example, a concession and a close.</strong><ul>'+
        ...
        '<li>To concede in four seconds and keep the position.</li>'+
        '<li>To close before the clock closes for her.</li></ul>',
  product:'Six timed answers: four in round one, then two in round two after a single targeted adjustment.',
  criteria:'<ul>'+
    '<li>The position arrives within eight seconds in at least four of the six.</li>'+
  ...
  difficulties:'<strong>She will explain both sides before choosing.</strong> It is the most common way to run out of time, and it is the most likely thing to happen at stage 2. Let it happen. The whole lesson depends on her hearing herself do it.<br><br>'+
    '<strong>She may write during the fifteen seconds.</strong> Anyone who writes runs out of time reading. Say the rule once, at stage 1, and do not repeat it.<br><br>'+
    '<strong>She may go for the best position rather than a position.</strong> In forty-five seconds, deciding is worth more than deciding well.',
  scaffolding:'The frames are on screen at stage 5 and <strong>come off for both rounds</strong>. Nothing is on screen during a timed answer except the prompt. If she asks for the frames back, say they come back next lesson &mdash; the point of the round is what survives without them.',
