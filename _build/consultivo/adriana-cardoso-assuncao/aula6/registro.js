{n:6,bloco:1,mod:'Grammar',cod:'G1',fwNome:'Grammar for Communication',
    tema:'Since When?',      temaPre:'Before the update',
    ...
    stages:[
      ...
      {n:'Personalized practice',min:7},
      {n:'Communicative task',min:9},
      {n:'Feedback + retask',min:5}
    ]}
