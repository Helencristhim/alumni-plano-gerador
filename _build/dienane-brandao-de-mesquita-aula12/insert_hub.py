#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 12 nos hubs (prof + aluno) de dienane-brandao-de-mesquita
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-12 ja existe, aborta.
Molde: diogo-leal-aula8/insert_hub.py."""
import os, re
...
ORDER_AMAP = '  "[order-l12]": "/audio/dienane-brandao-de-mesquita/pc12_order_getting_dressed.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('dienane-brandao-de-mesquita-aula11.html?autostart=1')
