#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 10 da Karina nos hubs (prof + aluno) de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l10]": "/audio/karina-macedo/a10_order_review.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('karina-macedo-aula9.html?autostart=1')
...
patch(os.path.join(ROOT, 'public', 'professor', 'karina-macedo.html'), True)
patch(os.path.join(ROOT, 'public', 'aluno', 'karina-macedo.html'), False)
print('OK')
