#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 19 da Tania Rosa nos hubs
monoliticos (inline) prof/aluno. NAO toca aulas 1-18. Adiciona: card IN CLASS (so
prof, link para o standalone com ?autostart=1), stamp19, accordion Pre-class, bloco
Complementares, entradas audioMap (+ [problem-l19]) e ajusta totalLessons 18->19.
...
# o snippet nao inclui a chave [problem-l19] (usada no card "ordem" do Pre-class) — adicionar
amap_lines.append(f'  "[problem-l19]": "{AUDIO_BASE}pc19_problem_order.mp3",')
amap_block = '\n'.join(amap_lines)
...
COMP_BLOCK = (
    ...
    'Materiais Complementares &mdash; Aula 19</h3>\n'
    '<p style="font-size:.82rem;color:var(--text-dim);margin-bottom:1.5rem">Tema da aula: pedir ajuda e resolver problemas &mdash; '
    'fazer uma reclama&ccedil;&atilde;o educada e dar conselhos quando algo d&aacute; errado numa viagem. '
    'Foco: should + verbo (conselho) e had better + verbo (conselho forte) '
    '(You should ask for a refund; you had better call the staff now) e vocabul&aacute;rio de problemas '
    '(complaint, refund, broken, delayed, missing, staff). '
...
CARD19 = (
    '    <a href="/professor/tania-rosa-aula19.html?autostart=1" '
    ...
    '      <div><div style="font-weight:600;font-size:.95rem">Asking for Help &amp; Solving Problems</div>'
    '<div style="font-size:.8rem;color:var(--text-dim)">should &amp; had better &mdash; 28 slides</div></div>\n'
    '    </a>')

STAMP18 = ('<div class="stamp" id="stamp18" data-label="Telling a Story" style="background-image:url(\''
           'https://images.unsplash.com/photo-1455390582262-044cdead277a?w=200&q=80\')"></div>')
STAMP19 = ('\n<div class="stamp" id="stamp19" data-label="Solving Problems" style="background-image:url(\''
           'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=200&q=80\')"></div>')

# anchor da ultima IN CLASS card (aula 18, Telling a Story) no prof
CARD18_TAIL = (
    '<div style="font-weight:600;font-size:.95rem">Telling a Story</div>'
