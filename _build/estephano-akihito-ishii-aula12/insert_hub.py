#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 12 nos hubs (prof + aluno) de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l12]": "/audio/estephano-akihito-ishii/a12_order_requests.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula11.html?autostart=1')
