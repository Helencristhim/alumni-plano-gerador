...
ORDER_AMAP = '  "[order-l16]": "/audio/andreia-heins/a16_order_proposal.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('andreia-heins-aula15.html?autostart=1')
...
patch(os.path.join(ROOT, 'public', 'professor', 'andreia-heins.html'), True)
patch(os.path.join(ROOT, 'public', 'aluno', 'andreia-heins.html'), False)
print('OK')
