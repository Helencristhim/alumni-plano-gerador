...
pairs = [
    ("Dream", "a big wish for your future"),
    ("Future", "the time that comes after now"),
    ("Opportunity", "a good chance to do something"),
    ("Challenge", "a difficult thing you try to do"),
    ("Success", "when you reach what you want"),
    ("Career", "the work you do over many years"),
    ("Skill", "something you can do well"),
    ("To improve", "to get better at something"),
    ("To achieve", "to reach a goal after hard work"),
    ("To grow", "to become bigger or stronger"),
]
