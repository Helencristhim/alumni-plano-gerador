#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 16 nos hubs (prof + aluno) de graziele-dias de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l16]": "/audio/graziele-dias/pc16_order_l16.mp3",'
...
def patch(path, is_prof):
    ...
    assert m, f'{path}: stamp15 nao encontrado'
    s = s[:m.end()] + '\n' + stamp + s[m.end():]
    ...
    if is_prof:
        ci = s.index('graziele-dias-aula15.html?autostart=1')
