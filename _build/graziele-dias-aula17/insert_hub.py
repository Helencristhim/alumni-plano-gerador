#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 17 nos hubs (prof + aluno) de graziele-dias de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l17]": "/audio/graziele-dias/pc17_order_l17.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('graziele-dias-aula16.html?autostart=1')
