#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 10 nos hubs (prof + aluno) de forma ADITIVA.
Aulas passadas intactas. Idempotente: se ex-lesson-10 ja existe, aborta."""
import os, re
...
ORDER_AMAP = '  "[order-l10]": "/audio/estephano-akihito-ishii/a10_order_phone.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula9.html?autostart=1')
