#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 15 nos hubs (prof + aluno) de dienane-brandao-de-mesquita
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-15 ja existe, aborta.
Molde: aula 14 insert_hub.py."""
import os, re
...
ORDER_AMAP = '  "[order-l15]": "/audio/dienane-brandao-de-mesquita/pc15_order_invite_friend.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('dienane-brandao-de-mesquita-aula14.html?autostart=1')
