...
amap_lines.append(f'  "[order-l18]": "{AUDIO_BASE}pc18_order_form.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), no formato das cards existentes da Anna (accent-light) ---
CARD18 = (
    '  <a href="/professor/anna-flavia-miranda-da-silva-aula18.html?autostart=1" target="_blank" '
...
STAMP17 = ('<div class="stamp" id="stamp17" data-label="Deal" style="background-image:url(\''
           'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=200&q=80\')"></div>')
STAMP18 = ('\n        <div class="stamp" id="stamp18" data-label="Documents" style="background-image:url(\''
