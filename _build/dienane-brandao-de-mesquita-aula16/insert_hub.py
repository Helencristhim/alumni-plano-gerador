#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 16 nos hubs (prof + aluno) de dienane-brandao-de-mesquita
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-16 ja existe, aborta.
Molde: aula 15 insert_hub.py."""
import os, re
...
ORDER_AMAP = '  "[order-l16]": "/audio/dienane-brandao-de-mesquita/pc16_order_future_plan.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('dienane-brandao-de-mesquita-aula15.html?autostart=1')
...
patch(os.path.join(ROOT, 'public', 'professor', 'dienane-brandao-de-mesquita.html'), True)
patch(os.path.join(ROOT, 'public', 'aluno', 'dienane-brandao-de-mesquita.html'), False)
print('OK')
