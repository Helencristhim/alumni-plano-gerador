#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Inline Aula 19 into the Elaine monolith (prof+aluno). ADITIVO ONLY: adds stamp19,
ex-lesson-19 (Pre-class), IN CLASS menu card startLesson(505,532), 28 slides (data-slide
505..532), slidePhases, audioMap, complementary l19. Bumps totalSlides 504->532 and
totalLessons ->19 (Pre-class progress loop). counterMap ja estendido ate vocabGrid30."""
import os, re, json
...
REF = os.path.join(HERE, '_standalone_ref', 'elaine-mieko-pinho-aula19.html')  # prof standalone = source of slides
N = 19; OFF = 28 * (N - 1)            # 504
VG = (23, 24)
TITLE = 'Small Talk -- Meeting People'; SUB = 'Starting a friendly conversation'
STAMP = '<div class="stamp" id="stamp19" data-label="Small Talk" style="background-image:url(\'https://images.unsplash.com/photo-1543269865-cbf427effbad?w=200&q=80\')"></div>'
PREV_STAMP = '<div class="stamp" id="stamp18" data-label="Taking Photos" style="background-image:url(\'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=200&q=80\')"></div>'
PREV_CARD_CLOSE = '</div><!-- /lesson-card L18 -->'
PREV_TOTSLIDES = 'var totalSlides = 504;'; NEW_TOTSLIDES = 'var totalSlides = 532;'
