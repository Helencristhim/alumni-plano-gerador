#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 14 nos hubs (prof + aluno) de dienane-brandao-de-mesquita
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-14 ja existe, aborta.
Molde: aula 13 insert_hub.py."""
import os, re
...
ORDER_AMAP = '  "[order-l14]": "/audio/dienane-brandao-de-mesquita/pc14_order_to_the_bank.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('dienane-brandao-de-mesquita-aula13.html?autostart=1')
