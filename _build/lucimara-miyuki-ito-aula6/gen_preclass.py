...
REGRA 13: a aluna e B1 -> ZERO portugues na tela. Vocab card leva DEFINICAO em ingles
  simples (nao traducao), o matching e palavra EN <-> definicao EN, o Grammar Tip e so
  em ingles, o data-hint e "Hint: ...", o speech card NAO tem .speech-translation e o
  survival card NAO tem .sp-pt. O portugues do PROFESSOR (Planejamento, data-teacher)
  continua — mas nada disso vive neste arquivo.
...
# (word, definicao EN simples, exemplo)
# A definicao e o que vai NO CARD e NO MATCHING (REGRA 13, B1 = zero portugues).
# Cada definicao e UNICA e contem function words (a/the/you/to/of/that/and/or/...).
VOCAB = [
...
A('      <div class="lesson-desc">In Lesson 5 you chose the perfect week. Now you have to GET there &mdash; and the city '
  'has rules that nobody explains to you. From the check-in kiosk in Guarulhos to the turnstile in Manhattan. Key words: '
  'connecting flight, departure gate, check-in kiosk, rideshare, curbside, turnstile, to tap in, platform, express '
  'train, to transfer, uptown, shuttle. Structure: <strong>modals of obligation, permission and prohibition</strong> '
  '&mdash; the grammar of a rule ("You <strong>have to</strong> tap your card before the turnstile." / "You '
  '<strong>don&#8217;t have to</strong> buy a ticket." / "You <strong>can&#8217;t</strong> smoke on the platform." / '
  '"You <strong>are allowed to</strong> take a bike, but not at rush hour."). The point that decides everything: '
  '<strong>don&#8217;t have to</strong> (it is optional) and <strong>can&#8217;t</strong> (it is forbidden) are '
  'OPPOSITES &mdash; even though both of them are negative.</div>')
...
A('      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Listen to each word and read the example. Take your time &mdash; listen twice, and say it out loud. These are the twelve words that live between the plane and the hotel: half of them are written on a sign, and nobody reads the sign for you.</p>')
...
# ---------- Stage 1.2 — Matching (REGRA 13: word EN <-> definition EN; REGRA 24: embaralhado) ----------
A('')
A('    <div class="exercise-section">')
A('      <div class="section-header-row"><h4>Stage 1.2: Matching</h4><span class="badge badge-practice">Practice</span></div>')
A('      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Match each word with the correct definition. Watch the pair that catches everybody: the <strong>check-in kiosk</strong> is the MACHINE (you talk to nobody); the <em>check-in counter</em> from Lesson 2 is the DESK, with a person behind it. In September, the line for one of them has forty people in it, and the line for the other one has two.</p>')
...
A('      </div>')
A('      <div class="quiz-item"><div class="quiz-question">1. "She <strong>does not have to</strong> talk to anybody." What does that tell you about the counter with a person behind it?</div><div class="quiz-options">'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">A</span> That she is NOT ALLOWED to talk to the agent at the counter.</div>'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="true"><span class="option-letter">B</span> That talking to the agent is OPTIONAL &mdash; she can do it if she wants, but she does not need to. <strong>Don&#8217;t have to</strong> = there is no obligation (and nothing stops you).</div>'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">C</span> That her English is not good enough for that.</div></div></div>')
A('      <div class="quiz-item"><div class="quiz-question">2. What is the difference between "he <strong>can&#8217;t</strong> wait" and "she <strong>doesn&#8217;t have to</strong> buy a ticket"?</div><div class="quiz-options">'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="true"><span class="option-letter">A</span> They are OPPOSITES. <strong>Can&#8217;t</strong> = forbidden or impossible (the rule stops him). <strong>Doesn&#8217;t have to</strong> = optional (nothing stops her &mdash; she simply does not need to).</div>'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">B</span> No difference &mdash; both of them are negative, so they mean the same thing.</div>'
...
A('      <div class="quiz-item"><div class="quiz-question">3. "Which platform <strong>does</strong> she <strong>have to</strong> be on?" Why is there a <strong>does</strong> in the question?</div><div class="quiz-options">'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">A</span> Because every question in English starts with <em>does</em>.</div>'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="true"><span class="option-letter">B</span> Because <strong>have to</strong> is a NORMAL verb &mdash; and a normal verb needs <em>do/does</em> to make a question. That is why we say "<strong>Do I have to</strong> transfer?" and never "<s>Do I must</s> transfer?".</div>'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">C</span> Because the sentence is in the past.</div></div></div>')
A('      <div class="quiz-item"><div class="quiz-question">4. Which sentence is correct?</div><div class="quiz-options">'
  '<div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">A</span> "You mustn&#8217;t buy a ticket &mdash; you can just tap your card." (this FORBIDS the person from buying a ticket!)</div>'
...
A('')
A('    <div class="exercise-section">')
A('      <div class="section-header-row"><h4>Stage 1.4: Grammar Tip -- Have to / Don&#8217;t have to / Can&#8217;t / Be allowed to (the grammar of a rule)</h4><span class="badge badge-vocab">GRAMMAR</span></div>')
A('      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem">A city is a set of rules. These are the five ways English says one.</p>')
...
A('        <tbody>')
A('          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600">have to<br>(affirmative)</td><td style="padding:.6rem"><strong>OBLIGATION</strong> &mdash; somebody else&#8217;s rule, not your own choice. This is the one an American SAYS (<em>must</em> is the one they write).</td><td style="padding:.6rem">"You <strong>have to</strong> tap your card."</td></tr>')
A('          <tr style="border-bottom:1px solid var(--border);background:var(--bg-elevated)"><td style="padding:.6rem;font-weight:600">must</td><td style="padding:.6rem">The SAME obligation, but you almost always <strong>read</strong> it: signs, regulations, contracts. Rare in speech.</td><td style="padding:.6rem">"Passengers <strong>must</strong> hold the handrail." (a sign in the subway)</td></tr>')
A('          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600;color:#15803d">don&#8217;t have to<br>(negative 1)</td><td style="padding:.6rem"><strong>NO OBLIGATION</strong> &mdash; it is OPTIONAL. You can do it if you want to: nothing stops you. <strong>This is NOT prohibition.</strong></td><td style="padding:.6rem">"You <strong>don&#8217;t have to</strong> buy a ticket." (you do not need one &mdash; but you may)</td></tr>')
A('          <tr style="border-bottom:1px solid var(--border);background:var(--bg-elevated)"><td style="padding:.6rem;font-weight:600;color:#b91c1c">can&#8217;t / must not<br>(negative 2)</td><td style="padding:.6rem"><strong>PROHIBITION</strong> &mdash; it is forbidden. If you do it, there is a consequence.</td><td style="padding:.6rem">"You <strong>can&#8217;t</strong> smoke on the platform."</td></tr>')
A('          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600">can /<br>be allowed to</td><td style="padding:.6rem"><strong>PERMISSION</strong> &mdash; the rule says yes. <em>Be allowed to</em> is the more formal one (and the one you see on an official notice).</td><td style="padding:.6rem">"You <strong>are allowed to</strong> take a bike, but not at rush hour."</td></tr>')
A('          <tr style="border-bottom:1px solid var(--border);background:var(--bg-elevated)"><td style="padding:.6rem;font-weight:600">The question</td><td style="padding:.6rem"><strong>Do I have to&#8230;?</strong> / <strong>Am I allowed to&#8230;?</strong> &mdash; <em>have to</em> is a normal verb: it needs <em>do/does</em>.</td><td style="padding:.6rem">"<strong>Do I have to</strong> transfer?" &mdash; never "<s>Do I must transfer?</s>"</td></tr>')
A('          <tr><td style="padding:.6rem;font-weight:600">The sound<br>(the important one)</td><td style="padding:.6rem" colspan="2">In an American mouth, <em>have to</em> does NOT sound like <em>have to</em>: it becomes <strong>HAFTA</strong>, with an F. <em>Has to</em> becomes <strong>HASTA</strong>. <em>Got to</em> becomes <strong>GOTTA</strong>. And <em>don&#8217;t have to</em> becomes <strong>DOAN-HAFTA</strong>, all in one piece. <strong>That is why you have never heard this grammar</strong> &mdash; it is everywhere, but it does not sound like the words you learned.</td></tr>')
A('        </tbody>')
A('      </table></div>')
A('      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.8rem"><strong>Watch out -- the classic mistake:</strong> both of them are negative, so the mind glues them together into one thing. In English they are <strong>OPPOSITES</strong>: <strong style="color:#15803d">don&#8217;t have to</strong> SETS YOU FREE (it is optional), <strong style="color:#b91c1c">mustn&#8217;t / can&#8217;t</strong> STOPS YOU (it is forbidden). If you tell a tourist "you mustn&#8217;t buy a ticket", you have just forbidden her to buy one. The question that always solves it: <em>does this sentence FREE me, or does it STOP me?</em></p>')
A('    </div>')

# ---------- Stage 1.5 — Fill in the blank ----------
BLANKS = [
    ("have to", "Hint: obligation -- the rule of the city (two words)",
     "You have to tap your card before you go through the turnstile.",
     '"You ', ' tap your card before you go through the turnstile."'),
    ("don't have to", "Hint: not forbidden -- it is only OPTIONAL (three words)",
     "You don't have to buy a ticket -- you can just tap your credit card.",
     '"You ', ' buy a ticket -- you can just tap your credit card."'),
    ("can't", "Hint: really forbidden -- there is a consequence (one word)",
     "You can't smoke on the platform.",
     '"You ', ' smoke on the platform."'),
    ("allowed", "Hint: formal permission -- Am I ___ to...?",
     "Am I allowed to take this suitcase through the gate?",
     '"Am I ', ' to take this suitcase through the gate?"'),
    ("transfer", "Hint: to get off one train and get on another one",
     "You have to transfer at 42nd Street to go downtown.",
     '"You have to ', ' at 42nd Street to go downtown."'),
    ("express", "Hint: the train that skips almost every station",
     "The express train doesn't stop at my station, so I have to take the local one.",
...
A('      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Complete each sentence. Tap Listen to hear the whole sentence &mdash; as many times as you want. Pay attention to the sound: <em>have to</em> is going to sound like <strong>HAFTA</strong>.</p>')
...
A('      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">From the kiosk in Guarulhos to the right platform in New York &mdash; the whole trip, in the order it really happens.</p>')
...
A('      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Listen to the sentence, say it out loud, and only then record. Today the target is ONE sound: <strong>have to</strong>, glued together. In an American mouth, <em>have to</em> becomes <strong>HAFTA</strong> (with an F!), <em>has to</em> becomes <strong>HASTA</strong>, and <em>don&#8217;t have to</em> becomes <strong>DOAN-HAFTA</strong>, all in one piece. If it comes out as "have &middot; to", separate, it is wrong &mdash; even when it is correct. It is not laziness: it is real English &mdash; and it is exactly why you do not hear the obligation when they speak.</p>')
for en in SPEECH:
...
QUIZ = [
    ("You have a big suitcase and the turnstile is too narrow for it. You ask the station agent:",
    ...
    ("Two platforms, the same letter, the same color. You have four seconds. The question that saves the trip is:",
     [("\"Which platform do I have to be on -- uptown or downtown?\"", True),
      ("\"How do I get to Midtown?\" (and then comes a fifteen-second answer that you do not understand)", False),
      ("\"Where is the train?\"", False)]),
    ("A tourist behind you is in line at the machine, about to buy a ticket she does not need. You want to SET HER FREE. You say:",
     [("\"You mustn't buy a ticket -- you can just tap your card.\" (this FORBIDS her from buying one!)", False),
    ...
    ("Your rideshare driver is waiting on Level 1, where pickup is forbidden, and the police are moving the cars along. You say:",
    ...
    ("The agent gave you the line, the platform and the transfer, all very fast. Before you walk away, you:",
     [("Say thank you and walk away, hoping that you understood him.", False),
      ("\"Let me check I understood: the E train, downtown platform, no transfer. Is that right?\"", True),
      ("\"Sorry, can you repeat everything again from the beginning?\" (and he repeats it just as fast)", False)]),
]
A('')
A('    <div class="exercise-section">')
A('      <div class="section-header-row"><h4>Stage 4: Situational Quiz</h4><span class="badge badge-quiz">Quiz</span></div>')
A('      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Choose the best answer. Question 3 is the trap of this lesson: not every negative sentence is a "no".</p>')
...
# ---------- Survival card (REGRA 13: B1 = so .sp-en, sem .sp-pt) ----------
A('')
