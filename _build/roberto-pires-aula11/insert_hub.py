#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 11 do Roberto Pires nos
hubs monoliticos (inline) prof/aluno. Nao toca aulas 1-10. Adiciona: card IN CLASS
(so prof), stamp11, accordion Pre-class, bloco Complementares, entradas audioMap
...
amap_lines.append(f'  "[order-l11]": "{AUDIO_BASE}pc11_order_directions.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), formato identico aos cards existentes do Roberto (accent) ---
CARD11 = (
    '    <a href="/professor/roberto-pires-aula11.html?autostart=1" '
...
STAMP10 = ('<div class="stamp" id="stamp10" data-label="Metro" style="background-image:url(\''
           'https://images.unsplash.com/photo-1534258936925-c58bed479fcb?w=200&q=80\')"></div>')
STAMP11 = ('\n        <div class="stamp" id="stamp11" data-label="On Foot" style="background-image:url(\''
           'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=200&q=80\')"></div>')

# tail do card IN CLASS da aula 10 (Metro + Buses) — ancora aditiva
CARD10_TAIL = (
    '      <div><div style="font-weight:600;font-size:.95rem">Metro + Buses</div>'
    '<div style="font-size:.8rem;color:var(--text-dim)">Transport Questions, Imperatives &#8212; 27 slides</div></div>\n'
    '    </a>')
