...
STAMP19 = ('<div class="stamp" id="stamp19" data-label="Present" '
           "style=\"background-image:url('https://images.unsplash.com/"
           "photo-1475721027785-f74eccf877e2?w=200&q=80')\"></div>")

AULA19_HREF = 'percival-jr-v2-aula19.html?autostart=1'
...
def patch(path, is_prof):
    ...
    # 2. stamp20 (apos stamp19 Present)
