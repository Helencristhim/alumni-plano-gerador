#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 18 nos hubs (prof + aluno) de dienane-brandao-de-mesquita
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-18 ja existe, aborta.
Molde: aula 17 insert_hub.py."""
import os, re
...
ORDER_AMAP = '  "[order-l18]": "/audio/dienane-brandao-de-mesquita/pc18_order_make_a_plan.mp3",'
...
def patch(path, is_prof):
    ...
    # 2. accordion ex-lesson-18 apos ex-lesson-17 (anchor no FIM do card, casando div/div)
    ...
    if is_prof:
        ci = s.index('dienane-brandao-de-mesquita-aula17.html?autostart=1')
