#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 19 nos hubs (prof + aluno) de forma ADITIVA.
Aulas passadas intactas. Idempotente: se ex-lesson-19 ja existe, aborta."""
import os, re
...
ORDER_AMAP = '  "[order-l19]": "/audio/andreia-heins/a19_order_feedback.mp3",'
...
accordion = between('<!-- 3. ACCORDION Pre-class (inserir após o ex-lesson anterior, prof E aluno) -->\n', '\n<!-- 3b. COMPLEMENTARES')
comp = between('<!-- 3b. COMPLEMENTARES da aula 19 (inserir na tab-complementary, prof E aluno) -->\n', '\n<!-- 4. ENTRADAS')
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('andreia-heins-aula18.html?autostart=1')
