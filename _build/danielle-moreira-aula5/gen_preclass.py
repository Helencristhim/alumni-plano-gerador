...
BLANKS = [
    ...
    ("It would", "appear that",
     "Hint: hedging your reading of the evidence &mdash; never 'it would seem to appear'",
    ...
    ("Any diagnosis that does not", "account for",
     "Hint: phrasal verb &mdash; account FOR (never 'account the')",
     "Any diagnosis that does not account for power distance will read the silence as agreement.",
...
HTML = f'''<div class="lesson-card" id="ex-lesson-5">
  <div class="lesson-header" onclick="toggleLesson(this)">
    ...
    <div class="lesson-header-content">
      ...
      <div class="lesson-desc">Explaining the difference between Brazilian and Canadian culture to a room of PhDs and directors &mdash; with no stereotype, no sweeping generalization, and no retreat from the observation itself: name the dimension, back it with evidence, and put the right cause under the spotlight. Key words: cultural intelligence, high-context culture, low-context culture, power distance, individualism and collectivism, indirect communication, assertiveness, cultural humility, work-life integration, inclusive leadership, to bridge cultural gaps, to read between the lines, to account for, to set out, to take into consideration. Structure: cleft sentences (It was the power distance that... / What this team needs is...) + hedging for comparative cultural analysis (One could argue that... / More often than not... / It would appear that... / For the most part...).</div>
  ...
  <div class="lesson-body">
    ...
    <div class="exercise-section">
      ...
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Listen to each term and read the example. This is the vocabulary the Canadian academics already use to describe you &mdash; from August on, it is the vocabulary you use to describe the room.</p>
...
{match_rows}
    ...
    <div class="exercise-section">
      ...
      <div class="quiz-item"><div class="quiz-question">1. Why is it &ldquo;It was the power distance <strong>that</strong> produced the silence&rdquo; and not &ldquo;...<strong>what</strong> produced the silence&rdquo;?</div><div class="quiz-options"><div class="quiz-option" onclick="selectQuiz(this)" data-correct="true"><span class="option-letter">A</span> Because in an it-cleft the link is always <strong>that</strong> (or <strong>who</strong>, with people). The &ldquo;what&rdquo; is a direct transfer from your first language.</div><div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">B</span> Because &ldquo;what&rdquo; only exists in questions.</div><div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">C</span> Because the subject is abstract and takes no relative pronoun.</div></div></div>
      <div class="quiz-item"><div class="quiz-question">2. &ldquo;<strong>What she learned that quarter was</strong> not a technique.&rdquo; &mdash; why do we NOT say &ldquo;What she learned that quarter <em>it was</em> not a technique&rdquo;?</div><div class="quiz-options"><div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">A</span> Because &ldquo;it&rdquo; can never appear in a sentence that opens with &ldquo;What&rdquo;.</div><div class="quiz-option" onclick="selectQuiz(this)" data-correct="true"><span class="option-letter">B</span> Because the wh-cleft <strong>already has</strong> its verb (What ... <strong>was</strong>). Adding &ldquo;it was&rdquo; says the verb twice &mdash; it is your first language leaking into the English.</div><div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">C</span> Because the subject of the sentence is feminine.</div></div></div>
    ...
    <div class="exercise-section">
      ...
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem">The grammar of the spotlight: the sentence splits in two to push ONE piece of it into the light &mdash; and hedging is what keeps that light from turning into a stereotype.</p>
      <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:.85rem;background:var(--bg-card);border:1px solid var(--border);border-radius:8px;overflow:hidden">
        ...
        <tbody>
          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600">It-cleft<br><strong>It was</strong> + X + <strong>that</strong> / <strong>who</strong></td><td style="padding:.6rem">The knife. Picks ONE cause and rules the others out.</td><td style="padding:.6rem"><strong>It was the power distance that</strong> produced the silence, not the language.</td></tr>
          <tr style="border-bottom:1px solid var(--border);background:var(--bg-elevated)"><td style="padding:.6rem;font-weight:600">Wh-cleft<br><strong>What</strong> + clause + <strong>is / was</strong> + X</td><td style="padding:.6rem">The stage. Holds the room until the last word, then lands it.</td><td style="padding:.6rem"><strong>What this faculty needs is</strong> to be asked before it is told.</td></tr>
          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600">Always <strong>It was</strong></td><td style="padding:.6rem">Even with a plural subject. Never &ldquo;It were&rdquo;.</td><td style="padding:.6rem"><strong>It was</strong> the academic directors <strong>who</strong> pushed back.</td></tr>
          <tr style="border-bottom:1px solid var(--border);background:var(--bg-elevated)"><td style="padding:.6rem;font-weight:600">Hedging: a tendency</td><td style="padding:.6rem">Turns a rule into a tendency.</td><td style="padding:.6rem"><strong>More often than not</strong>, feedback here is delivered indirectly.</td></tr>
          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600">Hedging: reading the evidence</td><td style="padding:.6rem">An interpretation, not a verdict.</td><td style="padding:.6rem"><strong>It would appear that</strong> the silence has more to do with hierarchy.</td></tr>
          <tr style="border-bottom:1px solid var(--border);background:var(--bg-elevated)"><td style="padding:.6rem;font-weight:600">Hedging: open and protect</td><td style="padding:.6rem">Opens the claim, then shields it.</td><td style="padding:.6rem"><strong>One could argue that</strong>... &middot; <strong>For the most part</strong>... &middot; <strong>That said, I would be careful not to overgeneralize.</strong></td></tr>
          <tr><td style="padding:.6rem;font-weight:600">Collocation</td><td style="padding:.6rem" colspan="2">take <strong>into</strong> consideration (never &ldquo;take in consideration&rdquo;) &middot; <strong>account for</strong> a factor (never &ldquo;account the factor&rdquo;) &middot; <strong>set out</strong> the expectations (never &ldquo;set the expectations out of&rdquo;) &middot; <strong>bridge</strong> cultural gaps (never &ldquo;make a bridge in the culture&rdquo;)</td></tr>
        </tbody>
      </table></div>
      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.8rem"><strong>Watch out (slip number 1):</strong> in the it-cleft the link is <strong>that</strong>, never &ldquo;what&rdquo;. &ldquo;It was the power distance <em>what</em> made them silent&rdquo; is your first language arriving intact. With people, use <strong>who</strong>.</p>
      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.5rem"><strong>Watch out (slip number 2):</strong> in the wh-cleft the verb is already there. &ldquo;What surprised me most <em>it was</em> the directness&rdquo; says the verb twice. The correct form is &ldquo;What surprised me most <strong>was</strong> the directness&rdquo;.</p>
      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.5rem"><strong>Dosage:</strong> hedging is not insecurity &mdash; it is PRECISION. &ldquo;Brazilians avoid conflict&rdquo; is a stereotype, and a PhD will take it apart in ten seconds. &ldquo;More often than not, difficult feedback in our Brazilian teams is delivered indirectly&rdquo; is an observation, and he will argue with you instead of dismissing you.</p>
      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.5rem"><strong>The combination you want:</strong> hedge + cleft in the SAME sentence. &ldquo;<strong>It would appear that it was</strong> the power distance, rather than the language, <strong>that</strong> kept them quiet.&rdquo; It is the most senior sentence in this lesson.</p>
    </div>
...
{fill_items}
    ...
    <div class="exercise-section">
      ...
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Put the five moves in the order in which you will run the first session with the Canadian academic team.</p>
    ...
    <div class="exercise-section">
      ...
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Listen to each sentence, then record yourself saying it. These are the five sentences of your first session with the Canadian academic team, in the order you will say them.</p>
{speech_cards}
    </div>

    <div class="exercise-section">
      <div class="section-header-row"><h4>Stage 4: Situational Quiz</h4><span class="badge badge-quiz">Quiz</span></div>
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Choose the best answer for each real moment of your session with the Canadian academics.</p>
