#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 13 nos hubs (prof + aluno) de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l13]": "/audio/estephano-akihito-ishii/a13_order_feelings.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula12.html?autostart=1')
