#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 20 nos hubs (prof + aluno) de forma ADITIVA.
Aulas passadas intactas. Idempotente: se ex-lesson-20 ja existe, aborta."""
import os, re
...
ORDER_AMAP = '  "[order-l20]": "/audio/andreia-heins/a20_order_meeting.mp3",'
...
comp = between('<!-- 3b. COMPLEMENTARES da aula 20 (inserir na tab-complementary, prof E aluno) -->\n', '\n<!-- 4. ENTRADAS')
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('andreia-heins-aula19.html?autostart=1')
