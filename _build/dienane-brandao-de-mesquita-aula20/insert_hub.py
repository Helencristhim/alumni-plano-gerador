#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 20 nos hubs (prof + aluno) de dienane-brandao-de-mesquita
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-20 ja existe, aborta.
Molde: aula 19 insert_hub.py."""
import os, re
...
ORDER_AMAP = '  "[order-l20]": "/audio/dienane-brandao-de-mesquita/pc20_order_phone_call.mp3",'
...
def patch(path, is_prof):
    ...
    # 2. accordion ex-lesson-20 apos ex-lesson-19 (anchor no FIM do card, casando div/div)
    ...
    if is_prof:
        ci = s.index('dienane-brandao-de-mesquita-aula19.html?autostart=1')
