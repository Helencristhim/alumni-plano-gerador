#!/usr/bin/env python3
"""Generate ElevenLabs MP3s for Rafael Aula 6 from phrases.json. Skips existing (REGRA C9)."""
import os, json, time, urllib.request, sys

HERE = os.path.dirname(os.path.abspath(__file__))
# wt-patricia worktree root = three levels up from _build/rafael-aula6
ROOT = os.path.abspath(os.path.join(HERE, '..', '..'))
OUT  = os.path.join(ROOT, 'public', 'audio', 'rafael-gasparelli-lima')

VOICES = {
    'arthur': 'sfJopaWaOtauCD3HKX6Q',  # Male (protagonist)
    'ellen': 'BIvP0GN1cAtSRTxNHnWS',   # Female
