#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 17 do Walyson nos hubs
monoliticos (inline) prof/aluno. Nao toca aulas 1-16. Adiciona: card IN CLASS
...
amap_lines.append(f'  "[order-l17]": "{AUDIO_BASE}pc17_order_confirmation_email_steps.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), formato identico aos cards existentes do Walyson (accent) ---
CARD17 = (
    '    <a href="/professor/walyson-ginaldo-silva-aula17.html?autostart=1"  '
...
STAMP16 = ('<div class="stamp" id="stamp16" data-label="Deal Negotiator" style="background-image:url(\''
           'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=200&q=80\')"></div>')
STAMP17 = ('\n<div class="stamp" id="stamp17" data-label="Deal Sealer" style="background-image:url(\''
           'https://images.unsplash.com/photo-1556745757-8d76bdb6984b?w=200&q=80\')"></div>')

# tail do card IN CLASS da aula 16 (Negotiating by Email) — ancora aditiva (so prof)
CARD16_TAIL = (
