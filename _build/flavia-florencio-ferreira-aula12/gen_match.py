...
pairs = [
    ("Pitch", "a short talk to present and sell your idea"),
    ("Idea", "a new thought or plan in your mind"),
    ("Problem", "a difficult thing that you need to solve"),
    ("Solution", "the answer that solves a problem"),
    ("Benefit", "a good thing that something gives you"),
    ("Reason", "why you do or think something"),
    ("Result", "what happens at the end, after your work"),
    ("Message", "the main point you want people to remember"),
    ("Clear", "easy to see or understand"),
    ("Summary", "a short version with only the main points"),
]
