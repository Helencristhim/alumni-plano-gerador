...
Nao toca aulas 1-19. So adiciona: card IN CLASS (so prof), stamp20, accordion
Pre-class, bloco de Complementares, entradas de audioMap (+ [order-l20]) e
ajusta var totalLessons=19 -> 20. Fragmentos vem dos arquivos do builder.
"""
import os
import re
...
amap_lines.append(f'  "[order-l20]": "{AUDIO_BASE}pc20_order_culture.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), no formato das cards existentes da Anna (accent-light) ---
CARD20 = (
    '  <a href="/professor/anna-flavia-miranda-da-silva-aula20.html?autostart=1" target="_blank" '
    ...
    '    <div><div style="font-weight:600;font-size:.95rem">Cultural Differences</div>'
    '<div style="font-size:.8rem;color:var(--text-dim)">Superlatives and polite business culture -- 27 slides</div></div>\n'
    '  </a>')

STAMP19 = ('<div class="stamp" id="stamp19" data-label="Video Call" style="background-image:url(\''
           'https://images.unsplash.com/photo-1588196749597-9ff075ee6b5b?w=200&q=80\')"></div>')
STAMP20 = ('\n        <div class="stamp" id="stamp20" data-label="Culture" style="background-image:url(\''
           'https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?w=200&q=80\')"></div>')
