...
ORDER_AMAP = '  "[order-l16]": "/audio/rubens-tofolo/a16_order_appointment.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('rubens-tofolo-aula15.html?autostart=1')
...
patch(os.path.join(ROOT, 'public', 'professor', 'rubens-tofolo.html'), True)
patch(os.path.join(ROOT, 'public', 'aluno', 'rubens-tofolo.html'), False)
print('OK')
