#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 9 nos hubs (prof + aluno) de forma ADITIVA.
Aulas passadas intactas. Idempotente: se ex-lesson-9 ja existe, aborta."""
import os, re
...
ORDER_AMAP = '  "[order-l9]": "/audio/estephano-akihito-ishii/a9_order_shopping.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula8.html?autostart=1')
