#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Inline Aula 13 into the Elaine monolith (prof+aluno), like aulas 8-12."""
import os, re, json
...
A = os.path.join(ROOT, 'public', 'professor', 'elaine-mieko-pinho-aula13.html')
N = 13; OFF = 28 * (N - 1)            # 336
VG = (11, 12)                         # vocab counter slots (a13)
TITLE = 'Asking for Directions'; SUB = 'Where is...? &amp; prepositions'
STAMP = '<div class="stamp" id="stamp13" data-label="Directions" style="background-image:url(\'https://images.unsplash.com/photo-1502920514313-52581002a659?w=200&q=80\')"></div>'
PREV_STAMP = '<div class="stamp" id="stamp12" data-label="Cafe" style="background-image:url(\'https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=200&q=80\')"></div>'
PREV_TOTLESS = 'var totalLessons = 12;'; NEW_TOTLESS = 'var totalLessons = 13;'
PREV_TOTSLIDES = 'var totalSlides = 336;'; NEW_TOTSLIDES = 'var totalSlides = 364;'
PREV_CARD_CLOSE = '</div><!-- /lesson-card L12 -->'
