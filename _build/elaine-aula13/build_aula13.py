...
PROF_OUT  = os.path.join(ROOT, 'public', 'professor', 'elaine-mieko-pinho-aula13.html')
ALUNO_OUT = os.path.join(ROOT, 'public', 'aluno', 'elaine-mieko-pinho-aula13.html')
GEN_OUT   = os.path.join(ROOT, 'scripts', 'generate-elaine-aula13-audio.js')
...
AUDIT = '''<!--
SCENARIO FIT — Aula 13
Can-do: "I can ask where a place is and follow directions."
Gramatica-alvo: "Where is + place?"; "How do I get to + place?"; imperativos (Go/Turn); preposicoes de lugar (next to / across from / between / on the corner).
Vocab-alvo: left, right, straight, corner, block, across from, next to, between.
Cenario escolhido: perdida na rua em New York, perguntando o caminho ate o museu/estacao.
Por que elicita o alvo: para achar um lugar o aluno PRECISA perguntar "Where is...?", entender left/right/straight e confirmar com preposicoes. >70% dos itens-alvo elicitados.

CONTINUIDADE — Aula 13
Itens novos: left, right, straight, corner, block, across from, next to, between; "Where is...?", "How do I get to...?", Go/Turn.
Itens revisados (L12): "Can I get a coffee?", small talk; Excuse me / thank you.
Callback no warm-up (slide 2): retoma ATIVAMENTE 2 itens da Aula 12 — o aluno ouve e repete "Can I get a coffee, please?" e "How is your day going?", e faz a ponte: terminou o cafe, agora precisa achar o museu e pede direcoes.
-->
'''

def build(scaffold, badge_is_aluno):
    h = scaffold
    h = must(h, 'Aula 9 | Restaurant Basics', 'Aula 13 | Asking for Directions')
    ...
    if not badge_is_aluno:
        MENU = ('  <h3 style="font-family:\'Cormorant Garamond\',serif;font-size:1.3rem;margin-bottom:1rem">IN CLASS &mdash; Aula 13</h3>\n'
                ...
                '      <div><div style="font-weight:600;font-size:.95rem">Asking for Directions</div><div style="font-size:.8rem;color:var(--text-dim)">Where is...? &amp; prepositions -- 28 slides</div></div>\n'
                '    </div>\n  </div>\n')
