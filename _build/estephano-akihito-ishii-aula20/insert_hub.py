...
ORDER_AMAP = '  "[order-l20]": "/audio/estephano-akihito-ishii/a20_order_one_match.mp3",'
...
def patch(path, is_prof):
    ...
    # 2. accordion ex-lesson-20 apos o FIM do card ex-lesson-19 (casando div/div)
    st = s.index('<div class="lesson-card" id="ex-lesson-19">')
    en = div_end(s, st)
    s = s[:en] + '\n' + accordion + s[en:]

    # 3. complementares l19 apos o ultimo wrapper l19
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula19.html?autostart=1')
