#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 13 da Pricila nos hubs
monoliticos (inline) prof/aluno. Nao toca aulas 1-12. Adiciona: card IN CLASS (so
prof), stamp13, accordion Pre-class, bloco Complementares, entradas audioMap
...
amap_lines.append(f'  "[order-l13]": "{AUDIO_BASE}pc13_order_plans.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), formato identico aos cards existentes da Pricila (accent) ---
CARD13 = (
    '    <a href="/professor/pricila-adamo-aula13.html?autostart=1" '
...
STAMP12 = ('<div class="stamp" id="stamp12" data-label="Opinions" style="background-image:url(\''
           'https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=200&q=80\')"></div>')
STAMP13 = ('\n        <div class="stamp" id="stamp13" data-label="Plans" style="background-image:url(\''
           'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=200&q=80\')"></div>')

# tail do card 12 (desc + </a>) -> ancoramos o card 13 logo depois
CARD12_TAIL = (
