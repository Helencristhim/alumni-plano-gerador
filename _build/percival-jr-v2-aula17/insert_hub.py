...
STAMP16 = ('<div class="stamp" id="stamp16" data-label="Replies" '
           "style=\"background-image:url('https://images.unsplash.com/"
           "photo-1563986768609-322da13575f3?w=200&q=80')\"></div>")

AULA16_HREF = 'percival-jr-v2-aula16.html?autostart=1'
...
def patch(path, is_prof):
    ...
    # 2. stamp17 (apos stamp16 Replies)
