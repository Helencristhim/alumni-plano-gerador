#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 6 nos hubs (prof + aluno) de forma ADITIVA.
Aulas passadas intactas. Idempotente: se ex-lesson-6 ja existe, aborta."""
import os, re, sys
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('diogo-leal-aula5.html?autostart=1')
