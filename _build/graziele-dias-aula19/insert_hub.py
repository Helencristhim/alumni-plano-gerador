#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 19 nos hubs (prof + aluno) de graziele-dias de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l19]": "/audio/graziele-dias/pc19_order_l19.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('graziele-dias-aula18.html?autostart=1')
