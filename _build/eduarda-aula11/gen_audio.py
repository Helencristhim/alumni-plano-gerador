#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate ElevenLabs MP3s for Eduarda Aula 6 from phrases.json. Skips existing (REGRA C9).
Roster per REGRA 35/C1 (arthur/ellen/josh/rachel/domi/bella). Model eleven_multilingual_v2."""
import os, json, time, urllib.request

HERE = os.path.dirname(os.path.abspath(__file__))
ROOT = os.path.dirname(os.path.dirname(HERE))
OUT  = os.path.join(ROOT, 'public', 'audio', 'eduarda-gabriel')
VOICES = {
