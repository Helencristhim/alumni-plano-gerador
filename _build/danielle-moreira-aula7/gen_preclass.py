...
BLANKS = [
    ("He apologized", "for reacting",
     "Hint: apologize FOR + the -ing form. Never 'apologized to react'",
    ...
    ("She suggested", "that I talk",
     "Hint: suggest + THAT + clause (or suggest + -ing). NEVER 'suggested me to talk'",
     "She suggested that I talk to him before the next steering meeting.",
     "to him before the next steering meeting."),
    ("He denied", "missing",
     "Hint: deny + the -ing form. Never 'denied to miss'",
    ...
    ("He accused the head office", "of imposing",
     "Hint: accuse somebody OF + the -ing form",
    ...
    ("He agreed", "to follow through",
     "Hint: agree + TO + infinitive. Never 'agreed following'",
    ...
    ("I encouraged him", "to take ownership",
     "Hint: encourage + OBJECT + TO + infinitive",
...
HTML = f'''<div class="lesson-card" id="ex-lesson-7">
  <div class="lesson-header" onclick="toggleLesson(this)">
    ...
    <div class="lesson-header-content">
      ...
      <div class="lesson-desc">Leading the conversation nobody wants to have: name a behavioral pattern with evidence, work through the defensiveness without wounding the person, close with a corrective action and a date on it &mdash; and then REPORT the conversation upward, with precision. Key words: constructive feedback, conflict resolution, blind spot, defensiveness, resistance to change, non-violent communication, growth mindset, behavioral pattern, performance gap, corrective action, to take ownership of, to address head-on, to follow through on, to sugarcoat, to beat around the bush. Structure: reporting verbs and their five complementation patterns (he acknowledged THAT... / he denied MISSING... / he apologized FOR reacting... / I encouraged him TO take... / he agreed TO follow through...).</div>
  ...
  <div class="lesson-body">
    ...
    <div class="exercise-section">
      ...
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Listen to each term and read the example. This is the vocabulary of a difficult conversation that ends in an agreement, not in resentment.</p>
...
{match_rows}
    ...
    <div class="exercise-section">
      ...
      <div class="quiz-item"><div class="quiz-question">1. &ldquo;<strong>He denied being</strong> resistant to the project.&rdquo; &mdash; why can you NOT say &ldquo;He denied <em>to be</em> resistant&rdquo;?</div><div class="quiz-options"><div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">A</span> Because <em>deny</em> never takes a complement of any kind, only a direct object.</div><div class="quiz-option" onclick="selectQuiz(this)" data-correct="true"><span class="option-letter">B</span> Because <strong>deny</strong> takes the <strong>-ing</strong> form (deny + -ing), never the infinitive. The pattern belongs to the VERB itself, and it has to be learned together with it.</div><div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">C</span> Because the sentence is in the past, and in the past the infinitive disappears.</div></div></div>
      <div class="quiz-item"><div class="quiz-question">2. The number one mistake of this lesson: why is &ldquo;She suggested <em>me to talk</em> to him&rdquo; wrong?</div><div class="quiz-options"><div class="quiz-option" onclick="selectQuiz(this)" data-correct="true"><span class="option-letter">A</span> Because <strong>suggest</strong> does NOT take an object + infinitive. It is &ldquo;suggested <strong>that I talk</strong> to him&rdquo; or &ldquo;suggested <strong>talking</strong> to him&rdquo;. The structure travels straight in from your first language and brings the whole sentence down.</div><div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">B</span> Because the correct form would be &ldquo;suggested me talking to him&rdquo;.</div><div class="quiz-option" onclick="selectQuiz(this)" data-correct="false"><span class="option-letter">C</span> Because <em>suggest</em> only exists in the passive voice.</div></div></div>
    ...
    <div class="exercise-section">
      ...
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem">Every reporting verb carries its own pattern, and the pattern cannot be worked out from the meaning: it is learned together with the verb. This is the grammar of the debrief &mdash; the moment you tell your VP what was said in the room.</p>
      <div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:.85rem;background:var(--bg-card);border:1px solid var(--border);border-radius:8px;overflow:hidden">
        <thead><tr style="background:var(--accent);color:#fff"><th style="padding:.7rem;text-align:left">Pattern</th><th style="padding:.7rem;text-align:left">Verbs</th><th style="padding:.7rem;text-align:left">Example</th></tr></thead>
        <tbody>
          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600">1. verb + <strong>that</strong> + clause</td><td style="padding:.6rem">acknowledge, point out, explain, insist, claim, admit, add</td><td style="padding:.6rem">He <strong>acknowledged that</strong> the deadlines had slipped.</td></tr>
          ...
          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600">3. verb + <strong>preposition</strong> + -ing</td><td style="padding:.6rem">apologize <strong>for</strong>, insist <strong>on</strong>, object <strong>to</strong>, accuse sb <strong>of</strong>, blame sb <strong>for</strong></td><td style="padding:.6rem">He <strong>apologized for reacting</strong> defensively. &middot; He <strong>accused</strong> the head office <strong>of imposing</strong> it.</td></tr>
          <tr style="border-bottom:1px solid var(--border);background:var(--bg-elevated)"><td style="padding:.6rem;font-weight:600">4. verb + <strong>object</strong> + <strong>to</strong> + infinitive</td><td style="padding:.6rem">encourage, urge, advise, remind, ask, invite, warn</td><td style="padding:.6rem">I <strong>encouraged him to take</strong> ownership of the rollout.</td></tr>
          <tr style="border-bottom:1px solid var(--border)"><td style="padding:.6rem;font-weight:600">5. verb + <strong>to</strong> + infinitive</td><td style="padding:.6rem">agree, refuse, promise, offer, threaten, decide</td><td style="padding:.6rem">He <strong>agreed to follow through</strong> on the corrective action.</td></tr>
          <tr><td style="padding:.6rem;font-weight:600">Backshift</td><td style="padding:.6rem" colspan="2">When you report in the past, the tense steps back ONE step: &ldquo;the dates <em>have</em> slipped&rdquo; &rarr; He acknowledged that the dates <strong>had</strong> slipped. But if the fact still holds today, keeping the present is perfectly acceptable: &ldquo;He insists that the timeline <strong>is</strong> impossible.&rdquo;</td></tr>
        </tbody>
      </table></div>
      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.8rem"><strong>Watch out (mistake number one):</strong> <em>suggest</em> does NOT take an object + infinitive. &ldquo;He suggested <em>me to talk</em> to her&rdquo; is the structure of your first language arriving intact. The correct form is &ldquo;He suggested <strong>that I talk</strong> to her&rdquo; or &ldquo;He suggested <strong>talking</strong> to her&rdquo;. The same goes for <em>recommend</em>.</p>
      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.5rem"><strong>Watch out (mistake number two):</strong> after a PREPOSITION you always use the <strong>-ing</strong> form, never the infinitive. &ldquo;He apologized <em>to react</em> defensively&rdquo; &#8594; &ldquo;He apologized <strong>for reacting</strong> defensively&rdquo;. Store each preposition glued to its verb: apologize <strong>for</strong>, insist <strong>on</strong>, object <strong>to</strong>, accuse somebody <strong>of</strong>.</p>
      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.5rem"><strong>Why this matters to you:</strong> the reporting verb you choose IS ALREADY an assessment. &ldquo;He <em>said</em> the timeline was impossible&rdquo; is neutral. &ldquo;He <strong>insisted that</strong> the timeline was impossible&rdquo; is a man who will not move. &ldquo;He <strong>acknowledged that</strong> the timeline was impossible&rdquo; is a man conceding a fact against himself. Same event, three readings &mdash; and your Canadian VP will read exactly the one you chose.</p>
      <p style="font-size:.82rem;color:var(--text-dim);margin-top:.5rem"><strong>The three-sentence debrief:</strong> what he <strong>acknowledged</strong>, what he <strong>denied</strong>, and what he <strong>agreed to do</strong>. In that order, and nothing else. It is the report your VP wants on Thursday.</p>
    </div>

    <div class="exercise-section">
      <div class="section-header-row"><h4>Stage 1.5: Fill in the Blank</h4><span class="badge badge-practice">Practice</span></div>
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Complete each sentence with the correct reporting verb pattern. Tap Listen to hear the full sentence.</p>
{fill_items}
    </div>
    ...
    <div class="exercise-section">
      ...
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Put the five moves in the order in which you will run the 1:1 with a Canadian coordinator who is resistant to change.</p>
    ...
    <div class="exercise-section">
      ...
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Listen to each sentence, then record yourself saying it. These are the five sentences that carry a difficult 1:1 from start to finish &mdash; and the debrief that comes after it.</p>
{speech_cards}
    </div>

    <div class="exercise-section">
      <div class="section-header-row"><h4>Stage 4: Situational Quiz</h4><span class="badge badge-quiz">Quiz</span></div>
      <p style="font-size:.82rem;color:var(--text-dim);margin-bottom:.8rem;font-style:italic">Choose the best answer for each real moment of your 1:1 with a Canadian coordinator.</p>
