#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Inline Aula 18 into the Elaine monolith (prof+aluno). ADITIVO ONLY: adds stamp18,
ex-lesson-18 (Pre-class), IN CLASS menu card startLesson(477,504), 28 slides (data-slide
477..504), slidePhases, audioMap, complementary l18. Bumps totalSlides 476->504 and
totalLessons ->18 (Pre-class progress loop). counterMap ja estendido ate vocabGrid30."""
import os, re, json
...
REF = os.path.join(HERE, '_standalone_ref', 'elaine-mieko-pinho-aula18.html')  # prof standalone = source of slides
N = 18; OFF = 28 * (N - 1)            # 476
VG = (21, 22)
TITLE = 'Taking Photos -- Asking Strangers'; SUB = 'Asking a stranger for a photo'
STAMP = '<div class="stamp" id="stamp18" data-label="Taking Photos" style="background-image:url(\'https://images.unsplash.com/photo-1502920917128-1aa500764cbd?w=200&q=80\')"></div>'
PREV_STAMP = '<div class="stamp" id="stamp17" data-label="Sightseeing" style="background-image:url(\'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?w=200&q=80\')"></div>'
PREV_CARD_CLOSE = '</div><!-- /lesson-card L17 -->'
PREV_TOTSLIDES = 'var totalSlides = 476;'; NEW_TOTSLIDES = 'var totalSlides = 504;'
