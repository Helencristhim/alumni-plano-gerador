...
CARD7 = (
    '  <a href="/professor/anna-flavia-miranda-da-silva-aula7.html?autostart=1" target="_blank" '
    ...
    'display:flex;align-items:center;justify-content:center;color:#fff;font-weight:700;font-size:1.1rem">07</div>\n'
    '    <div><div style="font-weight:600;font-size:.95rem">On the Phone</div>'
    '<div style="font-size:.8rem;color:var(--text-dim)">Numbers, dates &amp; polite phone calls -- 27 slides</div></div>\n'
    '  </a>')

STAMP6 = ('<div class="stamp" id="stamp6" data-label="Emails" style="background-image:url(\''
          'https://images.unsplash.com/photo-1596526131083-e8c633c948d2?w=200&q=80\')"></div>')
STAMP7 = ('\n        <div class="stamp" id="stamp7" data-label="Phone" style="background-image:url(\''
          'https://images.unsplash.com/photo-1423666639041-f56000c27a9a?w=200&q=80\')"></div>')

CARD06_TAIL = (
    '    <div><div style="font-weight:600;font-size:.95rem">Simple Emails</div>'
    '<div style="font-size:.8rem;color:var(--text-dim)">Can/Could, email vocabulary -- 29 slides</div></div>\n'
    '  </a>')
...
def patch(path, is_prof):
    ...
    s = s.replace(STAMP6, STAMP6 + STAMP7, 1); n += 1
    ...
    # 5. totalLessons
    assert 'var totalLessons=6;' in s, f'{path}: totalLessons=6 nao encontrado'
    ...
    if is_prof:
        ...
        s = s.replace(CARD06_TAIL, CARD06_TAIL + '\n' + CARD7, 1); n += 1
