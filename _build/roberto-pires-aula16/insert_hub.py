#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 16 do Roberto Pires nos
hubs monoliticos (inline) prof/aluno. Nao toca aulas 1-15. Adiciona: card IN CLASS
...
amap_lines.append(f'  "[order-l16]": "{AUDIO_BASE}pc16_trip_steps.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), formato identico aos cards existentes do Roberto (accent) ---
CARD16 = (
    '    <a href="/professor/roberto-pires-aula16.html?autostart=1" '
...
STAMP15 = ('<div class="stamp" id="stamp15" data-label="Small Talk" style="background-image:url(\''
           'https://images.unsplash.com/photo-1543269865-cbf427effbad?w=200&q=80\')"></div>')
STAMP16 = ('\n        <div class="stamp" id="stamp16" data-label="My Trip" style="background-image:url(\''
           'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=200&q=80\')"></div>')

# tail do card IN CLASS da aula 15 (Small Talk with Locals) — ancora aditiva
CARD15_TAIL = (
