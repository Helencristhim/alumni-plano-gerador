#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 19 nos hubs (prof + aluno) de dienane-brandao-de-mesquita
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-19 ja existe, aborta.
Molde: aula 18 insert_hub.py."""
import os, re
...
ORDER_AMAP = '  "[order-l19]": "/audio/dienane-brandao-de-mesquita/pc19_order_restaurant.mp3",'
...
def patch(path, is_prof):
    ...
    # 2. accordion ex-lesson-19 apos ex-lesson-18 (anchor no FIM do card, casando div/div)
    ...
    if is_prof:
        ci = s.index('dienane-brandao-de-mesquita-aula18.html?autostart=1')
