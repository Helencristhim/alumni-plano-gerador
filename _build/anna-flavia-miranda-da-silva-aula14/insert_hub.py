...
amap_lines.append(f'  "[order-l14]": "{AUDIO_BASE}pc14_order_lunch.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), no formato das cards existentes da Anna (accent-light) ---
CARD14 = (
    '  <a href="/professor/anna-flavia-miranda-da-silva-aula14.html?autostart=1" target="_blank" '
...
STAMP13 = ('<div class="stamp" id="stamp13" data-label="Numbers" style="background-image:url(\''
           'https://images.unsplash.com/photo-1543286386-713bdd548da4?w=200&q=80\')"></div>')
STAMP14 = ('\n        <div class="stamp" id="stamp14" data-label="Lunch" style="background-image:url(\''
