#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 16 nos hubs (prof + aluno) de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l16]": "/audio/estephano-akihito-ishii/a16_order_survival_day.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula15.html?autostart=1')
...
patch(os.path.join(ROOT, 'public', 'professor', 'estephano-akihito-ishii.html'), True)
patch(os.path.join(ROOT, 'public', 'aluno', 'estephano-akihito-ishii.html'), False)
print('OK')
