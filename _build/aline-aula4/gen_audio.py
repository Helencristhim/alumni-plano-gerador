#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate ElevenLabs MP3s for Aline Aula 4 from phrases.json. Skips existing files.
Model eleven_multilingual_v2. Voices: Ellen (female=Aline) / Arthur (male=Daniel)."""
import os, json, time, urllib.request, urllib.error

HERE = os.path.dirname(os.path.abspath(__file__))
ROOT = os.path.dirname(os.path.dirname(HERE))
OUTDIR = os.path.join(ROOT, 'public', 'audio', 'aline-sberci')
