#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets de UMA aula da Andrea Aggio no hub existente (prof + aluno),
ADITIVO. Uso: python3 _build/andrea-aggio-insert_hub.py N
...
- totalLessons -> N (ambos, se atual < N).
