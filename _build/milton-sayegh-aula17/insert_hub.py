#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 17 nos hubs (prof + aluno) de milton-sayegh
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-17 ja existe, SKIP.
Molde: milton-sayegh-aula16/insert_hub.py (sem extra-audio)."""
import os, re
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('milton-sayegh-aula16.html?autostart=1')
