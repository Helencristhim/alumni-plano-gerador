#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 18 nos hubs (prof + aluno) de graziele-dias de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l18]": "/audio/graziele-dias/pc18_order_l18.mp3",'
...
def patch(path, is_prof):
    ...
    assert m, f'{path}: stamp17 nao encontrado'
    s = s[:m.end()] + '\n' + stamp + s[m.end():]
    ...
    if is_prof:
        ci = s.index('graziele-dias-aula17.html?autostart=1')
