...
ORDER_AMAP = '  "[order-l18]": "/audio/andreia-heins/a18_order_deal.mp3",'
...
comp = between('<!-- 3b. COMPLEMENTARES da aula 18 (inserir na tab-complementary, prof E aluno) -->\n', '\n<!-- 4. ENTRADAS')
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('andreia-heins-aula17.html?autostart=1')
