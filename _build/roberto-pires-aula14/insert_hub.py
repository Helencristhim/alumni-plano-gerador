#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 14 do Roberto Pires nos
hubs monoliticos (inline) prof/aluno. Nao toca aulas 1-13. Adiciona: card IN CLASS
(so prof), stamp14, accordion Pre-class, bloco Complementares, entradas audioMap
(+ [order-l14]) e ajusta var totalLessons=13 -> 14.
"""
import os
import re
...
STAMP13 = ('<div class="stamp" id="stamp13" data-label="Eating Out" style="background-image:url(\''
           'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=200&q=80\')"></div>')
STAMP14 = ('\n        <div class="stamp" id="stamp14" data-label="Souvenirs" style="background-image:url(\''
           'https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?w=200&q=80\')"></div>')

# tail do card IN CLASS da aula 13 (Eating Out at a Restaurant) — ancora aditiva
CARD13_TAIL = (
