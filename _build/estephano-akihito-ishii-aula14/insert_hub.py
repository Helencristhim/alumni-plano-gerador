#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 14 nos hubs (prof + aluno) de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l14]": "/audio/estephano-akihito-ishii/a14_order_weather.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula13.html?autostart=1')
