#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""insert_hub.py — insere ADITIVAMENTE os snippets da aula 19 do Walyson nos hubs
monoliticos (inline) prof/aluno. Nao toca aulas 1-18. Adiciona: card IN CLASS
...
amap_lines.append(f'  "[order-l19]": "{AUDIO_BASE}pc19_dinner_steps.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), formato identico aos cards existentes do Walyson (accent) ---
CARD19 = (
    '    <a href="/professor/walyson-ginaldo-silva-aula19.html?autostart=1"  '
...
STAMP18 = ('<div class="stamp" id="stamp18" data-label="Rapport Builder" style="background-image:url(\''
           'https://images.unsplash.com/photo-1543269865-cbf427effbad?w=200&q=80\')"></div>')
STAMP19 = ('\n<div class="stamp" id="stamp19" data-label="Gracious Host" style="background-image:url(\''
           'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=200&q=80\')"></div>')

# tail do card IN CLASS da aula 18 (Small Talk Before Business) — ancora aditiva (so prof)
CARD18_TAIL = (
