#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 14 nos hubs (prof + aluno) de graziele-dias de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l14]": "/audio/graziele-dias/pc14_order_l14.mp3",'
...
def patch(path, is_prof):
    ...
    assert m, f'{path}: stamp13 nao encontrado'
    s = s[:m.end()] + '\n' + stamp + s[m.end():]
    ...
    if is_prof:
        ci = s.index('graziele-dias-aula13.html?autostart=1')
