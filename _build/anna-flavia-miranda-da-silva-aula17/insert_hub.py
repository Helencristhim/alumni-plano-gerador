...
amap_lines.append(f'  "[order-l17]": "{AUDIO_BASE}pc17_order_deal.mp3",')
amap_block = '\n'.join(amap_lines)

# --- card IN CLASS (so prof), no formato das cards existentes da Anna (accent-light) ---
CARD17 = (
    '  <a href="/professor/anna-flavia-miranda-da-silva-aula17.html?autostart=1" target="_blank" '
    ...
    '    <div><div style="font-weight:600;font-size:.95rem">Negotiation Basics</div>'
    '<div style="font-size:.8rem;color:var(--text-dim)">Making offers and simple deals -- 27 slides</div></div>\n'
    '  </a>')

STAMP16 = ('<div class="stamp" id="stamp16" data-label="Visitors" style="background-image:url(\''
           'https://images.unsplash.com/photo-1556761175-b413da4baf72?w=200&q=80\')"></div>')
STAMP17 = ('\n        <div class="stamp" id="stamp17" data-label="Deal" style="background-image:url(\''
