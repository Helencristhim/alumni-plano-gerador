...
def process(path, href_prefix):
    ...
    stamp_html = (f'\n<div class="stamp" id="stamp{N}" data-label="Presentation Skills" '
                  f"style=\"background-image:url('https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=200&q=80')\"></div>")
