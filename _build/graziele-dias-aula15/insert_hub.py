#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 15 nos hubs (prof + aluno) de graziele-dias de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l15]": "/audio/graziele-dias/pc15_order_l15.mp3",'
...
def patch(path, is_prof):
    ...
    assert m, f'{path}: stamp14 nao encontrado'
    s = s[:m.end()] + '\n' + stamp + s[m.end():]
    ...
    if is_prof:
        ci = s.index('graziele-dias-aula14.html?autostart=1')
