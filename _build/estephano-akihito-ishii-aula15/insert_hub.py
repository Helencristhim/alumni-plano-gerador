#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 15 nos hubs (prof + aluno) de forma ADITIVA.
...
ORDER_AMAP = '  "[order-l15]": "/audio/estephano-akihito-ishii/a15_order_doctor.mp3",'
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('estephano-akihito-ishii-aula14.html?autostart=1')
