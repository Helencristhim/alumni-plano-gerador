#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Insere os snippets da aula 13 nos hubs (prof + aluno) de milton-sayegh
de forma ADITIVA. Aulas passadas intactas. Idempotente: se ex-lesson-13 ja existe, SKIP.
Molde: milton-sayegh-aula12/insert_hub.py (sem extra-audio)."""
import os, re
...
def patch(path, is_prof):
    ...
    if is_prof:
        ci = s.index('milton-sayegh-aula12.html?autostart=1')
