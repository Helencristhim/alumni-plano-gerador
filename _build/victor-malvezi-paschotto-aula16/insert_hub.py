...
patch(os.path.join(ROOT, 'public', 'professor', 'victor-malvezi-paschotto.html'), True, 15)
patch(os.path.join(ROOT, 'public', 'aluno', 'victor-malvezi-paschotto.html'), False, 15)
print('OK')
