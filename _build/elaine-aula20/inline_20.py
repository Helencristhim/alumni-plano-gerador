#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Inline Aula 20 into the Elaine monolith (prof+aluno). ADITIVO ONLY: adds stamp20,
ex-lesson-20 (Pre-class), IN CLASS menu card startLesson(533,560), 28 slides (data-slide
533..560), slidePhases, audioMap, complementary l20. Bumps totalSlides 532->560 and
totalLessons ->20 (Pre-class progress loop). counterMap ja estendido ate vocabGrid30."""
import os, re, json
...
REF = os.path.join(HERE, '_standalone_ref', 'elaine-mieko-pinho-aula20.html')  # prof standalone = source of slides
N = 20; OFF = 28 * (N - 1)            # 532
VG = (25, 26)
TITLE = 'Phone Calls -- Reservations'; SUB = 'Making and answering a phone call'
STAMP = '<div class="stamp" id="stamp20" data-label="Phone Calls" style="background-image:url(\'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=200&q=80\')"></div>'
PREV_STAMP = '<div class="stamp" id="stamp19" data-label="Small Talk" style="background-image:url(\'https://images.unsplash.com/photo-1543269865-cbf427effbad?w=200&q=80\')"></div>'
PREV_CARD_CLOSE = '</div><!-- /lesson-card L19 -->'
PREV_TOTSLIDES = 'var totalSlides = 532;'; NEW_TOTSLIDES = 'var totalSlides = 560;'
